...
| 3 | Real archival / scientific footage | **PLANNED (next build)** | Add free sources beyond Pexels — NASA (already in), plus Wikimedia Commons / Openverse (public-domain telescope, microscopy, archival), Pixabay/Coverr video (free key). Real documentary/archival footage is the biggest "we don't look like everyone else" lever. Needs network-tested work + optional keys. |
